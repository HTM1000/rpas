...
# ========================================================================
# GENESYS - VERSAO PRODUCAO v3.0 (COM Validação por Imagem)
...
a = Analysis(
    ['RPA_Ciclo_GUI_v2.py', 'main_ciclo.py', 'validador_hibrido.py', 'telegram_notifier.py'],  # Incluir telegram_notifier
